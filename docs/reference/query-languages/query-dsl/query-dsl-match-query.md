...
`match` also works against [`semantic`](/reference/elasticsearch/mapping-reference/semantic.md) and [`semantic_text`](/reference/elasticsearch/mapping-reference/semantic-text.md) fields.
