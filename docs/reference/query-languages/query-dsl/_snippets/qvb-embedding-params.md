...
`timeout`
:   (Optional, [time value](docs-content://manage-data/query-your-data/query-dsl/common-options.md#time-units)) The timeout for the inference request. Defaults to `30s`.
