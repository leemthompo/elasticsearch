...
public class StGeohex extends SpatialGridFunction implements EvaluatorMapper {
    ...
    @FunctionInfo(
        ...
        description = """
            ...
            The result is long encoded. Use [`TO_STRING`](/reference/query-languages/esql/functions-operators/type-conversion-functions/to_string.md) to convert the result to a string,
            [`TO_LONG`](/reference/query-languages/esql/functions-operators/type-conversion-functions/to_long.md) to convert it to a `long`, or [`TO_GEOSHAPE`](/reference/query-languages/esql/functions-operators/type-conversion-functions/to_geoshape.md) to calculate
    ...
    public StGeohex(
        ...
        @Param(name = "bounds", type = { "geo_shape" }, description = """
            ...
            Use [`ST_ENVELOPE`](/reference/query-languages/esql/functions-operators/spatial-functions/st_envelope.md) if the `geo_shape` is of any other type.""", optional = true) Expression bounds
    ) {
